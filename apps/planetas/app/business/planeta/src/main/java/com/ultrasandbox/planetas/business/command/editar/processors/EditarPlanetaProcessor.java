package com.ultrasandbox.planetas.business.command.editar.processors;
...
public class EditarPlanetaProcessor implements Processor<AdicionarPlanetaOperation, AdicionarPlanetaOperation> {
